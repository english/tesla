...
/* 
AuthenticationApiService Get an Access Token
...
*/
func (a *AuthenticationApiService) CreateOauthToken(ctx context.Context, body CreateAccessTokenRequest) (CreateAccessTokenResponse, *http.Response, error) {
	var (
